...
const ReferralWidget: React.FC = () => {
  ...
  // Animate the commission earned value
  const animatedEarnings = useCountUp(199, 1500);
    ...
    <div className="bg-panel border border-border rounded-[32px] p-8 shadow-2xl relative overflow-hidden group">
      ...
      <div className="relative z-10 space-y-6">
        ...
        <div className="grid grid-cols-2 gap-4">
           ...
           <div className="p-4 bg-slate-950 rounded-2xl border border-white/5">
              <p className="text-[8px] font-black text-sher-muted uppercase mb-1">Commission Earned</p>
              <p className="text-lg font-black text-emerald-400 tabular-nums">₹{animatedEarnings}.<span className="text-xs">80</span></p>
           </div>
        </div>
